-- Migration: Promote external feed families to first-class layer signals
-- NOAA weather alerts and USGS earthquakes are high-volume official feeds.
-- They need dedicated categories and global official signals so users can
-- apply them like map layers.

-- Ensure system principals exist for official feed-owned signals.
...
-- Dedicated feed/layer categories.
...
-- Feed-specific types keep official feed items separate from community reports.
...
-- Reclassify already-ingested feed sightings into the new layer categories.
UPDATE sightings
SET
...
VALUES
  (
    ...
    'Weather Alerts',
    'Official NOAA weather alerts as a global map layer.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"categoryIds":["cat-weather-alerts"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Tornado Alerts',
    'Official tornado watches and warnings.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"typeIds":["type-tornado-alert"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Flood Alerts',
    'Official flood and flash flood alerts.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"typeIds":["type-flood-alert"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Severe Storm Alerts',
    'Official severe thunderstorm watches and warnings.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"typeIds":["type-severe-thunderstorm-alert"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Official winter storm, blizzard, and ice storm alerts.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"typeIds":["type-winter-storm-alert"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Official hurricane and tropical storm alerts.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"typeIds":["type-hurricane-alert"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Heat Alerts',
    'Official heat advisories, watches, and warnings.',
    'system-noaa',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"typeIds":["type-heat-alert"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
  ...
  (
    ...
    'Earthquakes',
    'Official USGS earthquake events as a global map layer.',
    'system-usgs',
    '{"kind":"global"}'::jsonb,
    ARRAY['new_sighting']::text[],
    '{"categoryIds":["cat-seismic-events"]}'::jsonb,
    TRUE,
    'official',
    0,
    0,
...
-- Backfill layer membership for existing feed sightings.
...
UPDATE signals
SET sighting_count = counts.total
FROM (
