...
async function seedTaxonomy() {
  ...
  const sightingTypes = [
    ...
    ['type-tornado-alert', 'Tornado Alert', 'cat-weather-alerts', 'sub-weather-warnings', ['weather', 'tornado', 'warning', 'watch', 'noaa'], '🌪️'],
    ['type-severe-thunderstorm-alert', 'Severe Thunderstorm Alert', 'cat-weather-alerts', 'sub-weather-warnings', ['weather', 'storm', 'thunderstorm', 'warning', 'noaa'], '⛈️'],
    ['type-flood-alert', 'Flood Alert', 'cat-weather-alerts', 'sub-weather-warnings', ['weather', 'flood', 'water', 'warning', 'noaa'], '🌊'],
    ['type-winter-storm-alert', 'Winter Storm Alert', 'cat-weather-alerts', 'sub-weather-warnings', ['weather', 'winter', 'snow', 'ice', 'noaa'], '❄️'],
    ['type-hurricane-alert', 'Tropical Cyclone Alert', 'cat-weather-alerts', 'sub-weather-warnings', ['weather', 'hurricane', 'tropical', 'warning', 'noaa'], '🌀'],
    ['type-heat-alert', 'Heat Alert', 'cat-weather-alerts', 'sub-weather-advisories', ['weather', 'heat', 'advisory', 'warning', 'noaa'], '🌡️'],
    ['type-weather-alert', 'Weather Alert', 'cat-weather-alerts', 'sub-weather-advisories', ['weather', 'alert', 'advisory', 'noaa'], '⚠️'],
    ['type-earthquake', 'Earthquake', 'cat-seismic-events', 'sub-earthquakes', ['geological', 'seismic', 'earthquake', 'usgs'], '🏔️'],
