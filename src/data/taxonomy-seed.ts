...
export const categories: Category[] = [
  ...
  {
    id: "cat-weather-alerts" as CategoryId,
    label: "Weather Alerts",
    icon: "⚠️",
    description:
      "Official watches, warnings, and advisories from weather feeds",
  },
  {
    id: "cat-seismic-events" as CategoryId,
    label: "Seismic Events",
    icon: "🏔️",
    description: "Earthquakes, tsunami risk, and geological event feeds",
  },
  {
...
export const subcategories: Subcategory[] = [
  ...
  {
    id: "sub-weather-warnings" as SubcategoryId,
    label: "Weather Warnings",
    categoryId: "cat-weather-alerts" as CategoryId,
    description: "Official weather warnings and watches",
  },
  {
    id: "sub-weather-advisories" as SubcategoryId,
    label: "Weather Advisories",
    categoryId: "cat-weather-alerts" as CategoryId,
    description: "Official weather advisories and lower-severity alerts",
  },
  {
    id: "sub-earthquakes" as SubcategoryId,
    label: "Earthquakes",
    categoryId: "cat-seismic-events" as CategoryId,
    description: "USGS earthquake events and seismic activity",
  },
  {
    id: "sub-tsunami-risk" as SubcategoryId,
    label: "Tsunami Risk",
    categoryId: "cat-seismic-events" as CategoryId,
    description: "Seismic events with tsunami risk metadata",
  },
...
export const sightingTypes: SightingType[] = [
  ...
  {
    id: "type-tornado-alert" as SightingTypeId,
    label: "Tornado Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-warnings" as SubcategoryId,
    tags: ["weather", "tornado", "warning", "watch", "noaa"],
    icon: "🌪️",
  },
  {
    id: "type-severe-thunderstorm-alert" as SightingTypeId,
    label: "Severe Thunderstorm Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-warnings" as SubcategoryId,
    tags: ["weather", "storm", "thunderstorm", "warning", "noaa"],
    icon: "⛈️",
  },
  {
    id: "type-flood-alert" as SightingTypeId,
    label: "Flood Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-warnings" as SubcategoryId,
    tags: ["weather", "flood", "water", "warning", "noaa"],
    icon: "🌊",
  },
  {
    id: "type-winter-storm-alert" as SightingTypeId,
    label: "Winter Storm Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-warnings" as SubcategoryId,
    tags: ["weather", "winter", "snow", "ice", "noaa"],
    icon: "❄️",
  },
  {
    id: "type-hurricane-alert" as SightingTypeId,
    label: "Tropical Cyclone Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-warnings" as SubcategoryId,
    tags: ["weather", "hurricane", "tropical", "warning", "noaa"],
    icon: "🌀",
  },
  {
    id: "type-heat-alert" as SightingTypeId,
    label: "Heat Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-advisories" as SubcategoryId,
    tags: ["weather", "heat", "advisory", "warning", "noaa"],
    icon: "🌡️",
  },
  {
    id: "type-weather-alert" as SightingTypeId,
    label: "Weather Alert",
    categoryId: "cat-weather-alerts" as CategoryId,
    subcategoryId: "sub-weather-advisories" as SubcategoryId,
    tags: ["weather", "alert", "advisory", "noaa"],
    icon: "⚠️",
  },
  {
    id: "type-earthquake" as SightingTypeId,
    label: "Earthquake",
    categoryId: "cat-seismic-events" as CategoryId,
    subcategoryId: "sub-earthquakes" as SubcategoryId,
    tags: ["geological", "seismic", "earthquake", "usgs"],
    icon: "🏔️",
  },
